          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              return listData.length > 0
                  ...
                  : JobsListCtrl().status == 'active'
                      ? Center(
                          child: new Text('press the (+) icon to add a new job',
                              style: titleFont))
                      : Center(
                          child: new Text('No data to display...paddingOnly()',
                              style: titleFont));
            }
            return Center(
              child: MyProgressBar(),
      ...
      child: new Card(
        ...
        child: ListTile(
          leading: CircleAvatar(
            ...
            radius: 25,
            child: new Icon(
              job.type == 'day' ? CupertinoIcons.sun_min : CupertinoIcons.time,
              color: Colors.white,
            ),
          ),
          title: new Text(
