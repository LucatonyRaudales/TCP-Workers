...
class SignUpPage extends StatelessWidget {
  ...
  Widget body({SignUpCtrl ctrl}){
    ...
    return Column(
      children: [
        Header(
          widgetToShow: Center(child: new Text('techno construction plus'.toUpperCase(), style: titleWhiteFont, textAlign: TextAlign.center,)),
        ),
        ...
        Padding(
          ...
          child: Form( 
                ...
                Padding(
                  ...
                  SizedBox(height:10),
                  TextButton.icon(
                    onPressed: ()=> Get.back(), icon: Icon(Icons.arrow_back), label: new Text('i have an account', style: bodyFont,))
              ],)
          ),
        ),
      ],
